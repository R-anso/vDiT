...
class WanSelfAttention(nn.Module):
    ...
    def forward(
        ...
        qk_kmean_analyzer: Optional[QK_kmean_Analyzer] = None,
    ):
        r"""
        Args:
        ...
        if qk_kmean_analyzer is not None:
            q_new = qk_kmean_analyzer.analyze(q_rot, layer_idx, iter_idx, key, grid_sizes)
            if q_new is not None:
                q_rot = q_new.unsqueeze(0)
